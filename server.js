...
var articles = { 
    ...
    'article-two':{
    title:'Article Two | Pramod Gopinath',
    heading: 'Article Two',
    date:'August 10,2017',
    content:
    `<p>
    ...
    'article-three':{
    title:'Article Three | Pramod Gopinath',
...
app.get('/articles/:articleName', function (req, res) {
    ...
    pool.query("SELECT * FRO article WHERE title = "+req.params.articleName,function(err,result){
        if(err){
            res.status(500).send(err.toString());
